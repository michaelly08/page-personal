                                ...
                                <div className="tiles-box">
                                    <div className="tiles">
                                        ...
                                        <div className="tiles-texts">
                                            ...
                                            <p>Built with React, API fetched with Redux. Shows the top 100 cryptocurrency, current price and in depth information about the coin when clicked on. Lastest news about crypto is also displayed and can be searched.</p>
                                            <div className="tiles-language">
                                                <div className="tiles-buttons">
